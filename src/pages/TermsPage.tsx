...
const TermsPage = () => (
	<div className={styles('termsPage')}>
		...
		<p>
			These Terms of Use (or "Terms") govern your use of Spaces, except where we
			expressly state that separate terms (and not these) apply, and provide
			information about the Spaces Service (the "Service"), outlined below. When
			you create a Spaces account or use Spaces, you agree to these terms.
		</p>
		<h2>The Spaces Service</h2>
		<p>
			We agree to provide you with the Spaces Service. The Service includes all
			of the Spaces products, features, applications, services, technologies,
			and software that we provide to advance Spaces's mission: To bring you
			closer to the people you love. The Service is made up of the following
			aspects:
		</p>
		<ul>
			<li>
				Offering opportunities to connect with people, build communities, and
				create, explore, and enjoy virtual worlds on the Spaces cloud.
			</li>
			<li>Fostering a positive, inclusive, and safe environment.</li>
		</ul>
		<h2>Your Commitments</h2>
		<p>
			<b>Who Can Use Spaces.</b> We want our Service to be as open and inclusive
			as possible, but we also want it to be safe, secure, and in accordance
			with the law. So, we need you to commit to a few restrictions in order to
			be part of the Spaces community.
		</p>
		<ul>
			<li>You must be at least 13 years old.</li>
			<li>
				You must not be prohibited from receiving any aspect of our Service
				under applicable laws or engaging in payments related Services if you
		...
		<p>
			<b>How you can't use Spaces.</b> Providing a safe and open Service for a
